...
class UsersTableSeeder extends Seeder
{
	...
	public function run()
	{
		...
		$stockiflyWarehouse = Warehouse::where('name', 'Stockifly')->first();
		...
		$admin->warehouse_id = $stockiflyWarehouse->id;
		...
		$salesman->warehouse_id = $stockiflyWarehouse->id;
		...
		$stockManager->warehouse_id = $stockiflyWarehouse->id;
